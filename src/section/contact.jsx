    ...
    return (
              ...
              >
                ...
                <div className="row text-center">
                  ...
                  >
                    ...
                    <h6>Email Me</h6>
                    <a href="rajithaubandara@gmail.com" style={{ textDecoration: 'none', color:"rgb(148, 148, 148)"}} >
      rajithaubandara@gmail.com
                  ...
                  >
                    <div className="wm-1"></div>
                    <h6>Call Me</h6>
                    <a href="tel:+1234567890" style={{ textDecoration: 'none', color:"rgb(148, 148, 148)" }}>
      +94 789 512 738
    </a>
                  </div>
                  <div
                  ...
                  >
                    <div className="wm-1"></div>
                    <h6>Whatsapp me </h6>
                    <a href="https://wa.me/+94789512738" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none',  color:"rgb(148, 148, 148)" }}>
      Chat on WhatsApp
    </a>
                  </div>
                </div>
